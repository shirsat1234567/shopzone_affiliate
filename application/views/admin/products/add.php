...
<!-- =======================
APPLICATION/VIEWS/ADMIN/PRODUCTS/ADD.PHP
======================= -->
        ...
        <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="category" name="category" 
                            ...
                            <?php foreach($categories as $category): ?>
                                <option value="<?= $category->name ?>" <?= set_select('category', $category->name) ?>>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="original_price" name="original_price" 
                               step="0.01" min="0" value="<?= set_value('original_price') ?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="discounted_price" name="discounted_price" 
                               step="0.01" min="0" value="<?= set_value('discounted_price') ?>" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="rating" name="rating" 
                               step="0.1" min="1" max="5" value="<?= set_value('rating') ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="reviews_count" name="reviews_count" 
                               min="0" value="<?= set_value('reviews_count') ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="affiliate_url" name="affiliate_url" 
                       value="<?= set_value('affiliate_url') ?>" required
                       placeholder="https://amazon.in/dp/product-id">
                <div class="form-text">Enter the Amazon affiliate link for this product</div>
            </div>

            <div class="mb-3">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="featured" name="featured" value="1" 
                           <?= set_checkbox('featured', '1') ?>>
