...
// Important settings for your config.php:

// $config['base_url'] = 'http://localhost/shopzone/'; // Change to your domain
// $config['index_page'] = '';
...
// $config['base_url'] = 'http://localhost/shopzone_affiliate/';
$config['base_url'] = 'https://shopme100.wuaze.com/';
